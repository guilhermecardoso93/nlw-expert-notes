    ...
    <Dialog.Root>
      <Dialog.Trigger className="rounded-md text-left bg-slate-800 p-5 flex flex-col gap-3 overflow-hidden relative hover:ring-2 hover:ring-slate-600 focus-visible:ring-2 focus-visible:ring-lime-400 outline-none">
        ...
        <Dialog.Portal>
          ...
          <Dialog.Content className="z-10 fixed left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 max-w-[640px] w-full h-[60vh] bg-slate-700 rounded-md flex flex-col outline-none overflow-hidden">

            <Dialog.Close className="absolute right-0 top-0 bg-slate-800 p-1.5">
              <X />
            </Dialog.Close>
            ...
            <button 
              type='button'
              className="w-full bg-slate-800 py-4 text-center text-sm outline-none text-slate-500 font-medium group"
            >
